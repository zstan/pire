...
#endif
/* Tokens.  */
#define YRE_LETTERS 258
#define YRE_COUNT 259
#define YRE_DOT 260
#define YRE_AND 261
#define YRE_NOT 262
...
{
      14,     0,    -1,    15,    -1,    16,    -1,    15,     8,    16,
      -1,    17,    -1,    16,     6,    17,    -1,    18,    -1,     7,
      18,    -1,    -1,    18,    19,    -1,    20,    -1,    20,     4,
      -1,     3,    -1,     5,    -1,     9,    -1,    10,    -1,    11,
      15,    12,    -1
};
...
{
       0,    76,    76,    85,    86,    90,    91,    95,    96,   100,
     101,   115,   116,   145,   146,   147,   148,   149
};
#endif
...
{
  "$end", "error", "$undefined", "YRE_LETTERS", "YRE_COUNT", "YRE_DOT",
  "YRE_AND", "YRE_NOT", "'|'", "'^'", "'$'", "'('", "')'", "$accept",
  "regexp", "alternative", "conjunction", "negation", "concatenation",
  "iteration", "term", 0
};
#endif
...
{
      11,     9,    12,     1,     8,    22,    13,    14,    15,     9,
      21,    10,    18,    20,     7,     0,     0,    19
};

static const yytype_int8 yycheck[] =
{
       3,     8,     5,     7,     0,    12,     9,    10,    11,     8,
       4,     6,     9,    15,     1,    -1,    -1,    10
};
...
{
       0,     7,    14,    15,    16,    17,    18,    18,     0,     8,
       6,     3,     5,     9,    10,    11,    19,    20,    16,    17,
      15,     4,    12
};
...
/* Line 1455 of yacc.c  */
#line 77 "re_parser.ypp"
    {
			ConvertToFSM(rlex.Encoding(), (yyvsp[(1) - (1)]));
			DoSwap(rlex.Retval(), *(yyvsp[(1) - (1)]));
			delete (yyvsp[(1) - (1)]);
		}
    break;
...
/* Line 1455 of yacc.c  */
#line 86 "re_parser.ypp"
    { ConvertToFSM(rlex.Encoding(), ((yyval) = (yyvsp[(1) - (3)]))) |= ConvertToFSM(rlex.Encoding(), (yyvsp[(3) - (3)])); delete (yyvsp[(3) - (3)]); }
    break;

  case 6:

/* Line 1455 of yacc.c  */
#line 91 "re_parser.ypp"
    { ConvertToFSM(rlex.Encoding(), ((yyval) = (yyvsp[(1) - (3)]))) &= ConvertToFSM(rlex.Encoding(), (yyvsp[(3) - (3)])); delete (yyvsp[(3) - (3)]); }
    break;
...
/* Line 1455 of yacc.c  */
#line 96 "re_parser.ypp"
    { ConvertToFSM(rlex.Encoding(), ((yyval) = (yyvsp[(2) - (2)]))).Complement(); }
    break;

  case 9:

/* Line 1455 of yacc.c  */
#line 100 "re_parser.ypp"
    { (yyval) = new Any(Fsm()); }
    break;
...
/* Line 1455 of yacc.c  */
#line 102 "re_parser.ypp"
    {
			Fsm& a = ConvertToFSM(rlex.Encoding(), ((yyval) = (yyvsp[(1) - (2)])));
			if ((yyvsp[(2) - (2)])->IsA<Term::CharacterRange>() && !(yyvsp[(2) - (2)])->As<Term::CharacterRange>().second)
				AppendRange(rlex.Encoding(), a, (yyvsp[(2) - (2)])->As<Term::CharacterRange>());
			else if ((yyvsp[(2) - (2)])->IsA<Term::DotTag>())
				rlex.Encoding().AppendDot(a);
			else
				a += ConvertToFSM(rlex.Encoding(), (yyvsp[(2) - (2)]));
			delete (yyvsp[(2) - (2)]);
		}
    break;
...
/* Line 1455 of yacc.c  */
#line 117 "re_parser.ypp"
    {
			Fsm& orig = ConvertToFSM(rlex.Encoding(), (yyvsp[(1) - (2)]));
			(yyval) = new Any(orig);
			Fsm& cur = (yyval)->As<Fsm>();
			const Term::RepetitionCount& repc = (yyvsp[(2) - (2)])->As<Term::RepetitionCount>();
...
/* Line 1455 of yacc.c  */
#line 149 "re_parser.ypp"
    { (yyval) = (yyvsp[(2) - (3)]); rlex.Parenthesized((yyval)->As<Fsm>()); }
    break;



/* Line 1455 of yacc.c  */
#line 1482 "re_parser.cpp"
      default: break;
    }
